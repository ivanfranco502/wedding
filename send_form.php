...
$your_email="ivanfranco502@gmail.com";
...
if(!empty($_POST)){
    ...
    $menues = '';
    if(isset($_POST['menues']) && $_POST['menues'] != ''){
        foreach($_POST['menues'] as $value){
            $menues .= ''.$value.', ';
        }
    }
    $name = $_POST['name'];
    ...
    if(mail($to, $subject, $message, $headers)){
        $result = '<img src="img/form-icon-ok.png"/><br /><span class="title success">Gracias!</span><br>Su confirmación ha sido enviada!<br /><br /><button class="btn btn-default BtnCloseResult" type="button">Cerrar</button>';
    }
}
